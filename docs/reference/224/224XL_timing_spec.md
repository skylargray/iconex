...
| ZERO/ | T&C tc_U48 -> ARU | strobe | microword ZERO-gate bit (MI25), gated at tc_U48 | high | active-LOW: low pulse at i2.AS0 (clears accumulator), high again at i2.AS1 (owner-read). ORIGIN (netlist 2T.3): ZERO/ = tc_U48.pin11 (74S00 g4) = NAND(tc_U19.Q6 [=MI25 ZERO-gate], AS0) -> ARU accumulator-reg /CLR aru_U45-49.pin1 (netlist 4.9). |
| XFER CK | T&C tc_U36 -> ARU | strobe | microword XFER bit (MI24), gated at tc_U36 | high | active-LOW: same low pulse at i2.AS0 as ZERO/ but ~20 ns lag behind it (owner-read). Latches ACC -> result register. ORIGIN (netlist 6T.4): XFER CK = tc_U36.pin6 (74S10 g2) = NAND(AS0, XFER [=tc_U19.Q5, MI24], tc_U25.pin9) -> ARU result-reg CP aru_U43/U44.pin11 (netlist 4.8). |
